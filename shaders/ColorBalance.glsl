...
uniform lowp vec3 inputShadowsShift;
uniform lowp vec3 inputMidtonesShift;
uniform lowp vec3 inputHighlightsShift;
uniform float inputPreserveLuminosity;
...
void main() {
    ...
    if (inputPreserveLuminosity != 0.0) {
