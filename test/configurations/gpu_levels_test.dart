...
void main() {
  ...
  group('GPULevelsConfiguration', () {
    ...
    test('change inputMinOutput', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputMinOutput')
              as Vector3Parameter;
      expect(parameter.value.storage, [0.0, 0.0, 0.0]);
    ...
    test('change inputMaxOutput', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputMaxOutput')
              as Vector3Parameter;
      expect(parameter.value.storage, [1.0, 1.0, 1.0]);
